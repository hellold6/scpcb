...
namespace SCPCB360.GameLogic
{
    ...
    public class RoomInstance
    {
        ...
        // Collision mesh (loaded from .rmesh file)
        public SCPCB360.Engine.CollisionMesh collisionMesh = null;
    ...
    public static class MapSystem
    {
                                             ...
                                             float rx = 0, float ry = 0, float rz = 0)
        {
            ...
            // Load collision mesh from RMESH file
            string rmeshPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "GFX", "map", $"{name}_opt.rmesh");
            if (!System.IO.File.Exists(rmeshPath))
                rmeshPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "GFX", "map", $"{name}.rmesh");
