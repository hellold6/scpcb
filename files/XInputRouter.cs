...
namespace SCPCB360.Input
{
    ...
    public static class XInputRouter
    {
        ...
        public static Vector2 GetLookDelta() => _lookDelta;
        ...
        /// </summary>
        public static float GetForwardAxis() => ApplyDeadZone(_current.ThumbSticks.Left.Y);

        /// <summary>Returns the strafe component (replaces Q/E or A/D strafing in CB)</summary>
        public static float GetStrafeAxis() => ApplyDeadZone(_current.ThumbSticks.Left.X);
